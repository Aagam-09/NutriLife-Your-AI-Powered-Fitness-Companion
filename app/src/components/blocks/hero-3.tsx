...
const ActionButton = ({ children, onClick }: { children: React.ReactNode, onClick?: () => void }) => (
    <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={onClick}
        className="mt-6 px-8 py-3 rounded-full bg-primary text-white font-semibold shadow-lg transition-colors hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary/40 focus:ring-opacity-75"
    >
        {children}
    </motion.button>
);
    ...
    return (
        ...
        >
            <div className="z-10 flex flex-col items-center">
                ...
                >
                    <ActionButton onClick={handleCTA}>{ctaText}</ActionButton>
                </motion.div>
            </div>
